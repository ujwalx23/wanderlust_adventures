...
export const blogs: Blog[] = [
  ...
  "Life once felt real in firsts and first trips, first conversations, spontaneous plans. That spark of newness made us alive. But now, routine and repetition dull everything. The internet makes all things instant. Fewer firsts. Fewer surprises. Less wonder. More sameness, day after day.",
  "It doesn’t always mean depression but sometimes it’s just disconnection. We’re so used to noise that silence feels unsettling. So used to distraction that stillness feels heavy. So used to stimulation that real life feels… flat. Disconnected from ourselves, from others, from the moment, everything feels unreal.",

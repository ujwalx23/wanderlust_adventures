...
const BooksPage = () => {
  const books = [
    ...
    },
    {
      ...
      image: "https://i.guim.co.uk/img/static/sys-images/Guardian/Pix/pictures/2014/10/28/1414502458130/Reese-Witherspoon-in-Wild-012.jpg?width=465&dpr=1&s=none&crop=none",

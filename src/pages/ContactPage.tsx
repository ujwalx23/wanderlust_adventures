        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-10 text-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm mb-8 max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-4">
                Please use our Google Form to submit your inquiry. We'll get back to you as soon as possible.
              </p>
              <Button 
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-6">                
                <div className="flex" id="general-inquiries">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+919876543210" className="hover:text-india-saffron transition-colors">
                        +91 98765 43210
                      </a>
                    </p>
                    <p className="text-gray-600">
                      <a href="tel:+918012345678" className="hover:text-india-saffron transition-colors">
                        +91 80 1234 5678
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex" id="destination-advice">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@wanderlustadventures.in" className="hover:text-india-saffron transition-colors">
                        info@wanderlustadventures.in
                      </a>
                    </p>
                    <p className="text-gray-600">
                      <a href="mailto:support@wanderlustadventures.in" className="hover:text-india-saffron transition-colors">
                        support@wanderlustadventures.in
                      </a>
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8" id="feedback">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.linkedin.com/in/ujwalsingh23" target="_blank" rel="noopener noreferrer" className="bg-gray-200 hover:bg-india-saffron hover:text-white p-2 rounded-full transition-colors">
            ...
            <div id="careers" className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-6">
                We use a Google Form to collect and organize inquiries. This helps us respond more efficiently to your questions and requests.
              </p>
